...
def measure_model_latency(model, device, example_inputs, iterations=1000):
    """测试模型的推理延迟。"""
...
def main(opt):
    ...
    mean_latency, std_latency = measure_model_latency(model, device, example_inputs, opt.testtime)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='runs/train/exp11/weights/best.pt', help='trained weights path')
